...
const Template = () => {
  return `
    ...
    <div class="hv-container hv-container_custom stories-container">container custom: 100% wide until custom breakpoint</div>
...
Overview.argTypes = {
  ['Containers']: {
    ...
    table: {
      type: { summary: [`${DEFAULT} | ${Object.values(ContainerResponsiveClasses).join(' |')} | .hv-container_custom | ${FIXED} | string`] },
